...
function buildPredictions(checkIn, profile, wearableData) {
  ...
  if (sleep !== null || stress !== null || recoveryScore !== null) {
    ...
    predictions.push({
      ...
      description:
        recoveryScore !== null
          ? "Estimated from your uploaded wearable recovery score, plus your check-in when available."
  ...
  if (steps !== null || activeMinutes !== null) {
    ...
    predictions.push({
      title: "Wearable activity support",
      level:
