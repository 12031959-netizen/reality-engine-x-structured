    ...
    <div className="page-stack">
      ...
      <section className="settings-grid">
        ...
        <article className="panel settings-panel">
          ...
          <p>
            Login details, diet profile, preferences, and feedback are stored
            locally in this browser for the demo.
          </p>
        </article>
      </section>
      ...
      <section className="panel settings-save-panel">
        <div>
          ...
          <p>Save reminder and privacy preferences to this local account.</p>
        </div>
